...
// 5-stage pipeline with forwarding unit for data hazard resolution
//============================================================================

module rv32i_pipe5_with_forwarding (
    input  logic        clk,
    input  logic        rst,
    ...
    //========================================================================
    // EX Stage: Execute with FORWARDING
    //========================================================================
    ...
    always_comb begin
        case (forward_a)
            2'b00: ex_alu_in1 = id_ex_rs1_data;      // From ID regfile read
            2'b01: ex_alu_in1 = wb_write_data;       // From WB stage
            2'b10: ex_alu_in1 = ex_mem_alu_result;   // From MEM stage
            default: ex_alu_in1 = id_ex_rs1_data;
        endcase
    end

    // Forwarding multiplexer for ALU input B
    always_comb begin
        case (forward_b)
            2'b00: begin
                if (id_ex_alu_src)
                    ex_alu_in2 = id_ex_imm;          // From immediate
                else
                    ex_alu_in2 = id_ex_rs2_data;     // From ID regfile read
            end
            2'b01: ex_alu_in2 = wb_write_data;       // From WB stage
            2'b10: ex_alu_in2 = ex_mem_alu_result;   // From MEM stage
